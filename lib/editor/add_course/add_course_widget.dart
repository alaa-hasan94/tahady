...
import '/editor/add_catecory/add_catecory_widget.dart';
          ...
          child: Padding(
            ...
            child: StreamBuilder<List<CategoryRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<CategoryRecord> scrollingColumnCategoryRecordList =
                    snapshot.data!;
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<CategoryRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CategoryRecord>
                                    dropDownCategoryRecordList = snapshot.data!;
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await coursesRecordReference
                              ...
                              courseTitle: _model.textController1.text,
                              courseDescription: _model.textController4.text,
                              courseImage: _model.uploadedFileUrl,
                              coursePrice:
                                  double.tryParse(_model.textController3.text),
                              courseTeacher: _model.textController2.text,
                              category:
                                  scrollingColumnCategoryRecord?.reference,
                            ));
                            _model.courses = CoursesRecord.getDocumentFromData(
                            ...
                            await LessonsRecord.collection
                                ...
                                .set(createLessonsRecordData(
                                  name: 'محاضرة  1',
                                  description: '',
                                  courseRef: _model.courses?.reference,
                                  lessonNumber: 1,
                                  youtube: '',
                                ));
