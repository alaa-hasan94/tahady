...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const HomeCopyWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/catecory',
          asyncParams: {
            'catecory': getDoc(['category'], CategoryRecord.fromSnapshot),
          },
          builder: (context, params) => CatecoryWidget(
            catecory: params.getParam('catecory', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'editCatecory',
