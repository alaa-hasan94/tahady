  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final authorprofileUsersRecord = snapshot.data!;
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            authorprofileUsersRecord.photoUrl,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          authorprofileUsersRecord.displayName,
                                    ...
                                    Text(
                                      authorprofileUsersRecord.title,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    formatNumber(
                                      authorprofileUsersRecord.numOfStudents,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    formatNumber(
                                      authorprofileUsersRecord.numOfCourses,
                                      formatType: FormatType.custom,
                                      format: '',
                                      locale: '',
                                    ),
                                ...
                                StreamBuilder<List<CoursesRecord>>(
                                  stream: queryCoursesRecord(
                                    queryBuilder: (coursesRecord) =>
                                        coursesRecord.where(
                                      'authors_email',
                                      isEqualTo: authorprofileUsersRecord.email,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
