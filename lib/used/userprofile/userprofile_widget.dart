                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Text(
                                '${valueOrDefault(currentUserDocument?.money, 0.0).toString()}د.ع ',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth('homeCopy', context.mounted);
                          },
                          text: 'تسجيل خروج',
                          options: FFButtonOptions(
                            width: double.infinity,
                            ...
                            var confirmDialogResponse = await showDialog<bool>(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text('هل تريد تأكيد حذف الحساب'),
                                      actions: [
                                        TextButton(
